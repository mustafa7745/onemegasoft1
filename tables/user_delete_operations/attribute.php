<?php
class UserDeleteOperationsAttribute
{
 
    public $name = "user_delete_operation";
    /////
    public $table_name = "user_delete_operations";
    public $user_delete_operation_id = "user_delete_operation_id";
    public $permission_id = "permission_id";
    public $user_session_id = "user_session_id";
    public $user_delete_operation_values = "user_delete_operation_values";
    public $user_delete_operation_created_at = "user_delete_operation_created_at";
    /////
